...
//  - https://github.com/soonuse/epd-library-arduino/blob/master/2.13inch_e-paper_b/epd2in13b/epd2in13b.cpp
// ========================================================

void WaveshareEPaper2P13InB::initialize() {
  // from https://www.waveshare.com/w/upload/d/d3/2.13inch-e-paper-b-Specification.pdf, page 37
  // EPD hardware init start
  this->reset_();
...
int WaveshareEPaper2P13InB::get_height_internal() { return 212; }
void WaveshareEPaper2P13InB::dump_config() {
  LOG_DISPLAY("", "Waveshare E-Paper", this);
  ESP_LOGCONFIG(TAG, "  Model: 2.3in (B)");
  LOG_PIN("  Reset Pin: ", this->reset_pin_);
  LOG_PIN("  DC Pin: ", this->dc_pin_);
  LOG_PIN("  Busy Pin: ", this->busy_pin_);
  LOG_UPDATE_INTERVAL(this);
